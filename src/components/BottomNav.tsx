...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 flex items-end justify-center px-4 pb-3">
      <div className="flex w-full max-w-sm items-center justify-between rounded-[25px] bg-[#F2F2F2] px-6 py-2 shadow-sm">
...
function ProfileIcon({ profile }: { profile?: { avatar_url?: string | null; display_name?: string | null } | null }) {
  ...
  return (
    <div className="h-[22px] w-[22px] overflow-hidden rounded-full border border-zinc-500 bg-zinc-700">
      <img
        src={src}
