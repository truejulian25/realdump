    ...
    <div className="flex min-h-screen flex-col bg-app-bg pt-14 pb-20">
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col gap-4 px-4 py-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-zinc-900">{t("filters.title")}</h1>
        </div>

        <div>
          <label className="mb-1 block text-sm font-medium text-zinc-700">{t("filters.filterWordsLabel")}</label>
          <textarea
            value={filterWords}
